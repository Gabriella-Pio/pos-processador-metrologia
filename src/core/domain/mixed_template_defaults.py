...
MIXED_SECTIONS_CONFIG: dict[str, dict] = {
    ...
    "resultados": {"enabled": True, "order": 6},
    "grafica": {"enabled": True, "order": 7},
    "tomografia": {"enabled": True, "order": 8},
    "resultados_inspecao": {"enabled": False, "order": 9},
    "interpretacao": {"enabled": True, "order": 10},
    "conclusao": {"enabled": True, "order": 11},
    "observacoes_limitacoes": {"enabled": False, "order": 12},
...
ESTATISTICO_SECTIONS_CONFIG: dict[str, dict] = {
    ...
    "metodo_escopo": {"enabled": False, "order": 3},
    "registro_componente": {"enabled": False, "order": 4},
    "controle_tecnico": {"enabled": False, "order": 5},
    "resultados": {"enabled": False, "order": 6},
    "grafica": {"enabled": False, "order": 7},
    "estat_resumo_diametros": {"enabled": False, "order": 8},
    "estat_resumo_alturas": {"enabled": False, "order": 9},
    "estat_resumo_dimensoes": {"enabled": False, "order": 10},
    "estat_resumo_cilindricidades": {"enabled": False, "order": 11},
    "estat_resumo_paralelismos": {"enabled": False, "order": 12},
    "estat_resumo_perpendicularidades": {"enabled": False, "order": 13},
    "estat_resumo_coaxialidades": {"enabled": False, "order": 14},
    "estat_resumo_angulos": {"enabled": False, "order": 15},
    "estat_resumo_outros": {"enabled": False, "order": 16},
    "estat_graficos": {"enabled": True, "order": 17},
    "estat_graficos_comp": {"enabled": True, "order": 18},
    "estat_detalhe_diametros": {"enabled": False, "order": 19},
    "estat_detalhe_alturas": {"enabled": False, "order": 20},
    "estat_detalhe_dimensoes": {"enabled": False, "order": 21},
    "estat_detalhe_cilindricidades": {"enabled": False, "order": 22},
    "estat_detalhe_paralelismos": {"enabled": False, "order": 23},
    "estat_detalhe_perpendicularidades": {"enabled": False, "order": 24},
    "estat_detalhe_coaxialidades": {"enabled": False, "order": 25},
    "estat_detalhe_angulos": {"enabled": False, "order": 26},
    "estat_detalhe_outros": {"enabled": False, "order": 27},
    "tomografia": {"enabled": False, "order": 28},
    "resultados_inspecao": {"enabled": False, "order": 29},
    "interpretacao": {"enabled": True, "order": 30},
    "conclusao": {"enabled": True, "order": 31},
    "observacoes_limitacoes": {"enabled": False, "order": 32},
    "historico_versoes": {"enabled": True, "order": 33},
