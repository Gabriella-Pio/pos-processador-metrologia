...
SECTION_CATALOG: tuple[SectionMeta, ...] = (
    ...
    _meta(
        "inspecao_optica",
        "Inspeção visual, macrográfica e óptica",
        pdf_heading="INSPEÇÃO VISUAL, MACROGRÁFICA E ÓPTICA",
        enabled_by_default=False,
        numbered=True,
    ),
    _meta(
        "resultados_superficies",
        "Resultados da avaliação das superfícies",
        pdf_heading="RESULTADOS DA AVALIAÇÃO DAS SUPERFÍCIES",
        enabled_by_default=False,
        numbered=True,
    ),
    _meta(
    ...
    _meta(
        "discussao_falha",
        "Discussão do mecanismo de falha",
        pdf_heading="DISCUSSÃO DO MECANISMO DE FALHA",
        enabled_by_default=False,
        numbered=True,
    ),
    _meta(
